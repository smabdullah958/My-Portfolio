...
// //                 <Image src={items.image} alt={items.name} fill />
// //               </div>
// //               <div className="p-4 text-center ">
// //                 <h2 className="text-lg sm:text-xl font-bold text-[#ece3e3]">
// //                   {items.name}
// //                 </h2>
...
//           <div
//             key={i}
//             className="relative bg-gray-800 rounded-2xl border-2 border-blue-200 overflow-hidden group hover:scale-105 transition-all duration-500"
//           >
//             {/* Image */}
//             <div className="relative w-full h-56">
//               <Image
...
//             {/* HOVER OVERLAY */}
//             <div className="absolute inset-0 bg-black/80 backdrop-blur-sm flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-300 px-4 text-left">
