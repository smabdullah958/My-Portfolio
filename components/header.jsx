...
const Header = () => {
  ...
  return (
    <>
      {/* Desktop Navbar */}
      <div className='hidden lg:h-40 md:flex md:items-center md:justify-between md:bg-[#292727] md:w-full md:px-5 md:py-3 md:shadow-md md:fixed md:top-0 z-50 h-20'>
