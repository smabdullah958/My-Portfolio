...
const ContactUs = () => {
  ...
  return (
    <div data-aos="fade-down" id="Contact" className="bg-gray-800 ">
      <h1 className="lg:text-4xl text-3xl pt-5 pb-8 sm:pt-10  text-center font-bold text-gray-100 ">
        Contact Me
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center  2xl:py-14  sm:px-16 px-10   md:pt-0 text-gray-100 text-xl ">
        <form
          ...
          className="order-1 md:order-2  md:mt-5 grid gap-4 md:mx-10 xl:mx-20"
        >
          <input
            type="text"
            name="UserName"
            ...
            className="w-full lg:w-[30vw] p-2 border border-gray-600 rounded-md mb-3"
          />
          ...
          <textarea
            ...
            onChange={HandleValues}
            placeholder="Message"
            className="mb-3 w-full lg:w-[30vw] p-2 border border-gray-600 rounded-md h-32"
          />
          ...
          <button
            ...
            onClick={HandleClick}
          >
            {Submitting === false ? "Sending..." : "Start a project"}
          </button>
        </form>
        ...
        <div className="mb-5 md:mb-0">
          ...
          <div className="text-sm font-bold  lg:w-[30vw] flex flex-col justify-start text-justify">
            <p className="text-lg  mb-5 font-bold text-gray-100 text-justify">
              Feel free to reach out for collaborations, business , projects, or
              consultations.
            </p>
